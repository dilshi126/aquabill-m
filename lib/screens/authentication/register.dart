  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            // Blue background for app name and description
            Container(
              color: Colors.blue,
              child: Column(
                children: [
                      ...
                      child: Column(children: [
                        ...
                        TextFormField(
                          ...
                          validator: (val) {
                            ...
                            // Validate NIC format
                            String pattern = r'^\d{9}[vVxX]$|^\d{12}$';
                            RegExp regExp = RegExp(pattern);
                            if (!regExp.hasMatch(val)) {
                              return "NIC must be 12 digits or 11 digits with last character 'V' or 'X'";
                            }
                            return null;
                          },
                          onChanged: (val) {
